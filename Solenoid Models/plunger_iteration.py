...
coil_thickness_range = [0.00635, 0.0127]
for coil_thickness in coil_thickness_range:
    femm.openfemm()
    ...
    print("Wire diameter: " + str(wire_diameter))
    print("Wire gauge: " + str(wire_selection_awg))
    # Turn calculation
    ...
    number_of_layers = round(coil_thickness/wire_diameter)
    ...
    print("Single First Layer Perimeter: " + str((4 * 2 * wire_diameter) + simple_inner_most_perimeter))
    print("Corner Perimeter: " + str(corner_perimeter_total))
    ...
    for side in range(0,2):
        ...
        coil_top_left = [direction_scale*(coil_inner_width + coil_thickness), coil_total_length/2]
    ...
    for t_whole in range(0,60):
        ...
        print("Current Inst: " + str(current_inst))
        ...
        print("Force: " + str(f_inst))
        print("Ampere-turn: " + str(current_inst*turns))
        # f = ma
        a_inst = f_inst / m 
        ...
        print("Distance moved: " + str(delta_d))
